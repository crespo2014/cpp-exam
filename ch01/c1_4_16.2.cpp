...
int main()
{
	...
	list<double> l1(a,a+18);
	list<double> l2(a,a+18);
...
/*
Console output 2
1.6 2.3 1.4 3.1 2.4 3.5 4.9 3.2 4.7 7.8 8 9.1 6.2 6.8 5.5 8.4 9.2 10
Deleting all subsequent  duplicates - int comparison
1.6 2.3 1.4 3.1 2.4 3.5 4.9 3.2 4.7 7.8 8 9.1 6.2 5.5 8.4 9.2 10
Deleting all subsequent  duplicates - int comparison - sorted
1.4 2.3 3.1 4.7 5.5 6.2 7.8 8 9.1 10
*/
