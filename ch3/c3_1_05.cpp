...
int main()
{
	...
	for_each(v1.begin(),v1.end(),static_cast<void (*)(const int&)>(print)); cout<<endl;
	cout<<endl;
	int ts[]={2,3};
	...
	for_each(v2.begin(), v2.end(), static_cast<void (*)(const int&)>(print)); cout<<endl;
	cout<<endl;
	char ts1[]={'a','b'};
...
Searching for any of elements 2, 3 from the beginning:
...
Searching for any of elements 'a', 'b' from the beginning:
Found value: a at position : 0
Looking for any other element with value 'a' or 'b'
Found value: b at position : 1
Found value: A at position : 4
Found value: b at position : 5
Found value: A at position : 7
Found value: b at position : 8
Found value: a at position : 10

Searching for any of elements 'a', 'b' from the beginning - case sensitive:
Found value: a at position : 0
Looking for any other element with value 'a' or 'b'
Found value: b at position : 1
Found value: b at position : 5
