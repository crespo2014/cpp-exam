...
int main()
{
    ...
    print(m1.rbegin(), m1.rend()); cout<<endl;
    print(m2.rbegin(), m2.rend()); cout<<endl;

    cout<<"Const iterators: \n";
    print(m1.cbegin(), m1.cend()); cout<<endl;
    print(m2.cbegin(), m2.cend()); cout<<endl;
    cout<<"Const iterators - reverse: \n";
    print(m1.crbegin(), m1.crend()); cout<<endl;
    print(m2.crbegin(), m2.crend()); cout<<endl;
...
/*
Console output:
Standard iterator (key only):
2 2 3 4 5 5 7 8 10 10
10 10 8 7 5 5 4 3 2 2
Reverse iterators:
10:10 10:10 8:8 7:7 5:5 5:5 4:4 3:3 2:2 2:2
2:2 2:2 3:3 4:4 5:5 5:5 7:7 8:8 10:10 10:10
Const iterators:
2:2 2:2 3:3 4:4 5:5 5:5 7:7 8:8 10:10 10:10
10:10 10:10 8:8 7:7 5:5 5:5 4:4 3:3 2:2 2:2
Const iterators - reverse:
10:10 10:10 8:8 7:7 5:5 5:5 4:4 3:3 2:2 2:2
2:2 2:2 3:3 4:4 5:5 5:5 7:7 8:8 10:10 10:10
*/
