...
int main()
{
	...
	printMessage(includes(d1.begin(), d1.end(), d2.begin(), d2.end())); cout<<endl;
	...
	cout<<"d2: "; 	print(d2.begin(), d2.end());cout<<endl;
	cout<<"Performing lookup:\n";
	printMessage(includes(d1.begin(), d1.end(), d2.begin(), d2.end(), compare)); cout<<endl;
...
d2: 8 4 5 6
Trying to perform lookup with not sorted collections:
...
d2: 4 5 6 8
Performing lookup:
Collection d1 contains all elements from collection d2!
