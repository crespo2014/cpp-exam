...
/*
Look for the first odd element in the container:
Found odd element: 3

Look for the first even element in the container:
Found Even element: 10

Look for the first odd element in the set:
Found odd element: 1

Look for the first even element in the set:
Found even element: 2
*/
