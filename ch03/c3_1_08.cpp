...
int main()
{
	...
	cout<<"v1: "; for_each(v1.begin(), v1.end(), static_cast<void (*)(const int&)>(print)); cout<<endl;
	cout<<"l1: "; for_each(l1.begin(), l1.end(), static_cast<void (*)(const int&)>(print)); cout<<endl;
	...
	cout<<"v2: "; for_each(v2.begin(), v2.end(), static_cast<void (*)(const int&)>(print)); cout<<endl;
	cout<<"l2: "; for_each(l2.begin(), l2.end(), static_cast<void (*)(const int&)>(print)); cout<<endl;
...
First not matching element - v2: d l2: D
